...
class MyApp(App):
    def build(self):
        ...
        label2 = Label(text='Shroom Action:')
        ...
        # Retune the label as the root widget
        return layout
    
    def on_move_release(self, button):
        distance = 5 # Distance can be as per your requirements
        self.distance_label = self.bm.move(distance)

    def on_shroom_release(self, button):
        self.distance_label.text.bm.eat.shroom()
